                ...
                <block v-if="orderTemplate == 1 || orderTemplate == 2">
                    <view class="me-fx-col me-fx-c address-info">
                        ...
                        <view class="me-fx-row me-fx-sb-c" v-else @tap="jumpAddressList">
                            ...
                            <image src="/static/pages/group_booking/imgs/pen-icon.png" class="pen-icon" @tap="jumpAddressList"></image>
                        </view>
                    </view>
                    <image src="/static/pages/img/order/address-border.png" class="address-border"></image>
                </block>
                ...
                <view class="me-fx-row me-fx-sb">
                    ...
                    <view class="me-fx-1 me-fx-col me-fx-sb">
                        ...
                        <view class="me-fx-row me-fx-sb-c">
                            ...
                            <add-subtract-num :def-count="buyCount" @change="countChange"></add-subtract-num>
                        </view>
                    </view>
                </view>
            </view>
...
export default {
    ...
    methods: {
        ...
        settlement() {
            ...
            var { userShipping, skuInfo, buyCount, merchantId, limitBuyCount, arriveTime, message, activityId, shareUserId, appid, commodityId, orderTemplate, isLocal } = this;
                    ...
                    uni.requestPayment({
                        ...
                        success: (res) => {
                            ...
                            var query = {
                                ...
                                orderType: this.orderTemplate
                            };

                            if (this.orderTemplate == 3) {
                                query.bookTime = this.showBookTime;
                            }
...
.goods-info .merchant-info {
    margin-bottom: 20rpx;
    font-size: 24rpx;
    color: #000;
}
.goods-info .merchant-info .avatar-img {
    width: 56rpx;
    height: 56rpx;
