            ...
            <view class="order-list" v-if="dataList.length">
                <view class="order-item" :data-item="item" v-for="(item, index) in dataList" :key="index">
                    ...
                    <view class="me-fx-row me-fx-end-c item-footer">
                        ...
                        <button class="btn red-btn" v-if="item.orderState == 1" :data-item="item" @tap.stop.prevent="showVerificationCode">核销码</button>
...
<style>
/* pages/group_booking/booking-list/booking-list.wxss */
