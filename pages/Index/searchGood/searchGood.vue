<template>
    <view>
        ...
        <view class="store-container" v-if="value">
            <view class="store-item" @tap="toStore" :data-name="item.commodityName" :data-id="item.id" v-for="(item, index) in goodsList" :key="index">
...
export default {
     ...
     */ methods: {
        ...
        searchStore() {
            ...
            return app.globalData.sjrequest('/commodity/searchCommodity', data).then((res) => {
