<template>
    <view style="background: #f7f7f7; min-height: 100vh">
        <view v-if="!saleGoodsList.length" class="no-dynamic">
                    ...
                    <view class="good-des">
                        ...
                        <view class="good-des-inner">
                            ...
                            <view class="good-inventory">
                                库存：
                                <text class="inventory">{{ goodsData.liveStock == -1 ? '有货' : goodsData.liveStock == 0 ? '暂无库存' : goodsData.liveStock }}</text>
                            </view>
...
export default {
    ...
    onShareAppMessage: function () {
        return {
            title: '邵阳人和秒杀专区',
            path: `/pages/Index/saleList/saleList?marchantId=${this.marchantId}`
        };
    },
    ...
    methods: {
        ...
        changeTime(e, _dataset) {
            ...
            this.setData({
                saleGoodsList: this.saleGoodsList
            });
        }
    }
};
