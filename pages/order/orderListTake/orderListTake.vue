<template>
    <view>
                                ...
                                <view class="order-content" :data-uniqueid="item.uniqueId" v-if="item.orderCommodity.length != 0" v-for="(item, index1) in orderList" :key="index1">
                                    ...
                                    <view class="order-title">
                                        ...
                                        <view class="order-status">
                                            <view v-if="tabsitem == 2" style="color: #2bc372">已完成</view>
                                            <view v-if="tabsitem == 1">待自取</view>
                                            <van-count-down
                                                v-if="tabsitem == 0"
                                                :time="item.endTime"
                                                format="待支付 mm:ss"
                                    ...
                                    <view class="order-footer" v-if="tabsitem != 2">
                                        <view class="btn-content-box">
                                            <view
                                                ...
                                                data-id="4"
                                                :data-marchantId="item.marchantId"
                                                v-if="tabsList[tabsitem].name === '待使用'"
                                            >
                                                确认核销
                                            </view>
                                            <view class="do-btn cancel-btn other_btn" @tap="showQR" :data-uniqueId="item.uniqueId" v-if="tabsList[tabsitem].name == '待使用'">
                                                查看券码
                                            </view>
                                            <view
                                                class="do-btn cancel-btn other_btn"
        ...
        <!-- 二维码核销 -->
        <van-popup v-show="showQRCode" @close="onClose" round closeable>
