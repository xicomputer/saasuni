<template>
    <view>
        ...
        <view class="goods-list">
            <!-- 横向 scroll-y='{{true}}' class='goods-scroll' -->
            <scroll-view v-if="typeModel == 0">
                <view class="me-fx-row me-fx-sb list-container">
                    <view class="goods-item" @tap="goshop" :data-id="item.commodityId" :data-name="item.commodityName" v-for="(item, index) in recommends" :key="index">
                        ...
                        <view class="goods-info">
                            ...
                            <view class="me-fx-row me-fx-sb-c">
                                ...
                                <image src="/static/pages/static/red_cart.png" class="cart-img" @tap="addCartGoods" :data-item="item"></image>
                            </view>
                        </view>
                    </view>
                </view>
            </scroll-view>
            <!-- 竖向 scroll-y='{{true}}' class='goods-scroll' -->
            <scroll-view v-else>
                    ...
                    <view class="me-fx-row goods2" @tap="goshop" :data-id="item.commodityId" :data-name="item.commodityName" v-for="(item, index) in recommends" :key="index">
                        ...
                        <view class="goods2-info me-fx-1 me-fx-col me-fx-sb">
                            ...
                            <view class="me-fx-row me-fx-start-c me-fx-sb">
                                ...
                                <view class="btn_cart11 me-fx-row me-fx-start-c" v-if="orderSwitch">
                                    <image class="cart-img2" src="/static/pages/static/cart11.png"></image>
                                    <text>全国发货</text>
                                </view>
                                <view class="btn_cart11 me-fx-row me-fx-c-c" v-else>
                                    <text>参考价</text>
                                </view>
                            </view>
                        </view>
