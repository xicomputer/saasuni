    ...
    <view>
        <block v-if="storeDynamicList.length">
            ...
            >
                ...
                <view class="msg_info">
                    <view class="me-fx-row msg_info_con">
                        <image class="msg_ldang" src="/static/pages/static/Ldang.png"></image>
                        <view class="msg_text">
                            因为小程序订阅都是一次性，所以订阅查看后下一次还需再次订阅
                            <text class="godynamic">通知列表>></text>
                        </view>
                    </view>
                </view>
            </navigator>
                            ...
                            <view class="dynamic-goods-container" v-if="item.commodity" @tap.stop.prevent="toBuy" :data-id="item.commodity.id">
                                ...
                                <view class="dynamic-goods-container-content">
                                    ...
                                    <view class="dynamic-goods-bottom">
                                        ...
                                        <view class="dynamic-goods-container-btn" v-if="orderSwitch">购买商品</view>
                                        <view class="dynamic-goods-container-btn" v-else>参考价</view>
                                    </view>
                                </view>
                            </view>
                        </navigator>
  ...
  <block wx:for="{{commentList}}" wx:key="index">
    <view class="user-dynamic-itme">
      ...
      <scroll-view style="width:100%;padding-top:20rpx" scroll-x wx:if="{{item.imagList.length}}">
        ...
        <no-data v-if="!storeDynamicList.length && !commentList.length" text="暂无动态消息" url=""></no-data>
    </view>
</template>

<script>
import noData from '@/pages/Component/noData/index';
import hotel from '@/pages/Component/hotel/index';
