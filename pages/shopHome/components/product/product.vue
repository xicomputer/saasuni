<template>
    <view>
        ...
        <view>
            ...
            <view>
                <text>综合排序</text>
                <image src="../../../static/images/Polygon 1@2x.png"></image>
            </view>
            <view>
                <text>价格</text>
                <view>
                    <image src="../../../static/images/Polygon 2@2x.png"></image>
                    <image src="../../../static/images/Polygon 1@2x.png"></image>
                </view>
            </view>
            <view>
            ...
            <!-- 瀑布流排版 -->
            <!-- <view class="goods" >
            <view  class="single-goods"  wx:for="{{goodsList}}"  wx:key="index" bindtap='toGoodsDetails' data-id='{{item.commodityId}}' style="position: relative;">
              <view	style="color:#fff;background:#ff0000;border-top-left-radius:15rpx;font-size:22rpx;padding: 6rpx 25rpx;position: absolute;top: 0;border-bottom-right-radius: 50rpx;">{{btnTitle}}</view>
                <image src="{{item.thumbnail}}"></image>
                <text class="line-clamp2"> {{item.commodityName}}</text>
                <view class="price">
                    <view class="price-new" style="font-size: 24rpx;">
                        <text class="yang1">￥</text>
                        <text>{{item.lowPrice}}</text>
                    </view> -->
            <!-- <view class="price-old">
                        <u-icon name="rmb" color="#999" size="18"></u-icon>
                        <text>699</text>
                    </view> -->
            <!-- 无商品旧价格 -->
            <!-- </view>
            ...
            <!-- 新版猜你喜欢 -->
            <view class="goods">
                <view class="single-goods" @tap="toGoodsDetails" :data-id="item.commodityId" style="position: relative" v-for="(item, index) in goodsList" :key="index">
                    <view
                        style="
                            color: #fff;
                            background: #ff0000;
...
export default {
    ...
    data() {
        return {
            ...
            currentIndex: 0,
            JifentimeData: {},
            footImg: '/static/pages/static/foot_Img.png',
    ...
    methods: {
        ...
        goColumn(e) {
            ...
            var mainOrderType = this.orderTemplate;
...
.sort view:nth-of-type(2) text {
    width: 80rpx;
}

.sort view:nth-of-type(2) > view {
    width: unset;
    height: 25rpx;
    display: flex;
...
.sort view:nth-of-type(3) text {
    width: 80rpx;
}

.sort view:nth-of-type(3) > view {
    width: unset;
    height: 25rpx;
    display: flex;
    flex-direction: column;
...
.goods .single-goods .price .price-new {
    display: flex;
}

.goods .single-goods .price .price-new u-icon {
    margin-top: 26rpx;
}

.goods .single-goods .price .price-new > text {
    font-size: 38rpx;
    color: #fa6b2b;
    font-weight: 500;
}

.goods .single-goods .price .price-old {
    display: flex;
    align-items: center;
    margin-top: 30rpx;
}

.goods .single-goods .price .price-old > text {
    position: relative;
    font-size: 24rpx;
    color: #999;
}

.goods .single-goods .price .price-old > text::before {
    content: '';
...
.temp1-product .classify-nav-list {
    width: 128rpx;
    height: 1000rpx;
}
.temp1-product .classify-nav-list .nav-item-text {
    height: 100rpx;
    font-size: 28rpx;
    color: #fff;
    box-sizing: border-box;
}
.temp1-product .classify-nav-list .sel-nav-item {
    background-color: #fff;
    color: #f69761;
}
.temp1-product .product-list {
    width: 602rpx;
    background-color: #fff;
    height: 1000rpx;
    padding-left: 20rpx;
...
.temp1-product .product-list .product-item:not(:last-child) {
    margin-bottom: 30rpx;
}
.temp1-product .product-list .product-img {
    width: 208rpx;
    height: 208rpx;
    background-color: #ccc;
    margin-right: 20rpx;
}
.temp1-product .product-list .product-name {
    font-size: 28rpx;
    color: #333;
    font-weight: bold;
}
.temp1-product .product-list .price-str {
    font-size: 24rpx;
    color: #fe4f4f;
}
.temp1-product .product-list .price-num {
    font-size: 36rpx;
    font-weight: bold;
}
.temp1-product .product-list .xf-btn {
    padding: 5rpx 20rpx;
    font-size: 24rpx;
    color: #fff;
    background-color: #f69761;
...
.c8_btn {
    background: linear-gradient(to right, #ff0202, #ffa32b);
...
.c8_btn1 {
    background: linear-gradient(to right, #ff0202, #ffa32b);
    padding: 8rpx 20rpx 12rpx 24rpx;
    border-radius: 40rpx 0 0 40rpx;
    line-height: 1;
    position: absolute;
    right: 0;
...
.temp2_product1_name {
    ...
    font-weight: bold;
    color: #080808;
    border-bottom: 6rpx solid #aab966;
    text-align: center;
}
...
.temp2_product2_foot {
    background: linear-gradient(90deg, #6da96a 0%, #37926e 100%);
    height: 130rpx;
    padding: 0rpx 50rpx;
    color: #fff;
}
...
.temp2_product2_money {
    margin-bottom: 5px;
    width: 100%;
    align-items: center;
}

.temp2_product2_price {
    color: #c0222a;
    font-size: 36rpx;
    font-weight: bold;
}
...
.product3-item2-info1 {
    background-color: #000;
    width: 490rpx;
}

.product3-item2-info2 {
    background-color: #000;
    width: 210rpx;
    text-align: center;
}
.product3-item2-text1 {
    font-size: 24rpx;
}
.product3-item2-text {
    font-size: 24rpx;
...
.temp-product4 .classify-nav-list .classify-name {
    margin-right: 70rpx;
    font-size: 26rpx;
    color: #fff;
}
.temp-product4 .classify-nav-list .sel-class-name {
    background: #fff;
    color: #5db6fa;
    padding: 0rpx 20rpx;
    border-radius: 30rpx;
...
.temp-product4 .product-list-box {
    flex-wrap: wrap;
}

.temp-product4 .product-list-box:after {
    content: '';
    width: 320rpx;
    height: 0px;
    visibility: hidden;
}
.temp-product4 .product-list-box .product-item {
    box-shadow: 0px 2px 3px rgba(0, 0, 0, 0.1);
    width: 344rpx;
    margin: 20rpx 0 0;
    border-radius: 20rpx;
...
.temp-product4 .product-list-box .product-item .goods-img {
    width: 344rpx;
    height: 344rpx;
}
.temp-product4 .product-list-box .product-item .product-name {
    font-size: 28rpx;
    box-sizing: border-box;
    font-weight: 600;
    padding: 12rpx;
}
.temp-product4 .product-list-box .product-item .price-box {
    padding-left: 12rpx;
    box-sizing: border-box;
}
.temp-product4 .product-list-box .product-item .price-str {
    font-size: 24rpx;
    color: #333;
}
.temp-product4 .product-list-box .product-item .price-num {
    font-size: 36rpx;
    font-weight: bold;
    font-family: 'DIN_font';
}
.temp-product4 .product-list-box .product-item .tcps-buy-btn {
    padding: 5rpx 20rpx;
    background-color: #5db6fa;
    color: #fff;
    border-radius: 28rpx 0 0 28rpx;
...
.temp-product4 .more-5 {
    margin-top: 20rpx;
    color: #000;
}
.temp-product4 .more-5 > text {
    background-color: #fff;
    border-radius: 18rpx;
    padding: 5rpx 20rpx;
    font-size: 28rpx;
