<template>
    ...
    >
        ...
        <image v-if="utils.isSrc(name)" :src="name" mode="aspectFit" class="van-icon__image" />
    </view>
</template>
...
@font-face {
    ...
    font-style: normal;
    font-display: auto;
    src: url(https://img.yzcdn.cn/vant/vant-icon-d3825a.woff2) format('woff2'), url(https://img.yzcdn.cn/vant/vant-icon-d3825a.woff) format('woff'),
